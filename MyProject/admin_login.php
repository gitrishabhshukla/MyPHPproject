...
<div class="container-fluid" style="background-color: blue;">
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
   ...
   <img src="adminlogin.png" width="200px" height="200px" style="margin-left:110px;">
    <div class="center-block" style="background-color:#4d94ff;border-radius:10px;padding:20px;">
  <form action="adminlogin_page.php" method="POST">
    <div class="form-group">
      <label for="rollNo"><b>username:</b></label>
      <input type="text" class="form-control" id="username" placeholder="Enter username" name="username" style="border:none;border-bottom:2px solid red;background-color:#4d94ff;">
    </div>
    <div class="form-group">
      <label for="pswd"><b>Password:</b></label>
      <input type="password" class="form-control" id="pswd" placeholder="Enter password" name="pswd" style="border:none;border-bottom:2px solid red;background-color:#4d94ff;">
    </div>
