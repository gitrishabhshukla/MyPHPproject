 ...
 <div class="container-fluid" style="background-color: blue;">
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
   ...
   <!-- Body -->
	...
	<div class="col-sm-8"><img src="car1.jpg" width="100%" height="300px;"></div>
     <div class="col-sm-2"></div>
    </div>
   	<div class="row">
     <div class="col-sm-3"></div>
	<div class="col-sm-6"><h3>You have been registerd successfully to our Complaint portal!!!</h3></div>
     <div class="col-sm-3"></div>
    </div>
	<div class="row">
     <div class="col-sm-3"></div>
	<div class="col-sm-6"><a href="Login.php"><button class="btn btn-success">Click here to Login to complaint portal</button></a></div>
     <div class="col-sm-3"></div>
    </div>
	</div><br><br><br>
	<div style="width:100%;">
