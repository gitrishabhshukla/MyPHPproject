...
body {
 ...
 <div class="container-fluid" style="background-color: blue;">
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
   ...
   <!-- Body -->
  <div class="container" >
  <div style="width: 40%;padding:20px 40px 20px 40px;" class="center-block">
  <img src="loginimg.png" width="300px" height="90px" style="margin-left:35px;" >
  <form name="myForm" action="SignUp_page.php" method="post">
